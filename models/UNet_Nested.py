...
from .utils import count_param, init_weights


class UNet_Nested(nn.Module):

    def __init__(self, in_channels=32, n_classes=5, feature_scale=2, is_deconv=True, is_batchnorm=True, is_ds=True):
...
if __name__ == '__main__':
    ...
    x = Variable(torch.rand(2,32,128,128)).cuda()
